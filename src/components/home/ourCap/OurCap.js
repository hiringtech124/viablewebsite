  ...
  return (
    <>
      <div className='bg-black h-full w-full text-[#fff] flex flex-col items-center gap-10 py-[40px]'>
        <h1 className='font-serif text-[45px] max-lg:text-[35px] max-md:text-[30px] max-sm:text-[25px] text-center text-[#F5F5F5]'>Our capabilities</h1>
        <div className='flex justify-center px-[20px] h-full gap-20 max-xl:gap-10 max-md:flex-wrap'>
          <div className='relative backImg text-black flex flex-col w-[300px] h-[450px] max-xl:w-[250px] max-xl:h-[400px] max-lg:w-[200px] max-lg:h-[350px] max-sm:w-[100px] max-sm:h-[150px]'>
            ...
            <div className='flex flex-col w-full h-full items-center pt-[50px] max-sm:pt-[20px] absolute z-3 text-container'>
              <h1 className='font-serif text-[42px] max-xl:text-[36px] max-lg:text-[30px] max-md:text-[24px] max-sm:text-[15px] font-bold'>Medal Making</h1>
          ...
          <div className='relative backImg text-black flex flex-col w-[300px] h-[450px] max-xl:w-[250px] max-xl:h-[400px] max-lg:w-[200px] max-lg:h-[350px] max-sm:w-[100px] max-sm:h-[150px]'>
            ...
            <div className='flex flex-col w-full h-full items-center pt-[50px] max-sm:pt-[20px] absolute z-3 text-container'>
              <h1 className='font-serif text-[42px] max-xl:text-[36px] max-lg:text-[30px] max-md:text-[24px] max-sm:text-[15px] font-bold'>Restoration</h1>
          ...
          <div className='relative backImg text-black flex flex-col w-[300px] h-[450px] max-xl:w-[250px] max-xl:h-[400px] max-lg:w-[200px] max-lg:h-[350px] max-sm:w-[100px] max-sm:h-[150px]'>
            ...
            <div className='flex flex-col w-full h-full items-center pt-[50px] max-sm:pt-[20px] absolute z-3 text-container'>
              <h1 className='font-serif text-[42px] max-xl:text-[36px] max-lg:text-[30px] max-md:text-[24px] max-sm:text-[15px] font-bold'>Fine Jewellery</h1>
